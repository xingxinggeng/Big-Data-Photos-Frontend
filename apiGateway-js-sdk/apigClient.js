...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://8j3mh40b77.execute-api.us-east-1.amazonaws.com/photoAlbum';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        var uploadBucketKeyPutRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['x-amz-meta-customLabels']),
            body: body
        };
